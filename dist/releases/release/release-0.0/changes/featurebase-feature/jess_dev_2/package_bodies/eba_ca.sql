...
-- changeset JESS_DEV_2:1765789859913 stripComments:false  logicalFilePath:featurebase-feature\jess_dev_2\package_bodies\eba_ca.sql
-- sqlcl_snapshot src/database/jess_dev_2/package_bodies/eba_ca.sql:null:2c8a83388cd9f331866ebe3a30eafbe282ed500c:create
...
create or replace package body eba_ca as 
    ...
    begin
        ...
        if eba_ca_fw.get_preference_value('ACCESS_CONTROL_ENABLED') = 'N' then
            ...
            if
                l_access_level_id = 1
                and eba_ca_fw.get_preference_value('ACCESS_CONTROL_SCOPE') = 'PUBLIC_CONTRIBUTE'
            then
                return 2;
            end if;
